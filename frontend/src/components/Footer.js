      ...
      <Container maxWidth="lg">
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={4}>
            ...
            <Typography variant="body2">
              Project Maintainer:{' '}
              <Link href="https://github.com/MeAkash77" color="inherit" sx={{ textDecoration: 'underline', '&:hover': { color: '#f57c00' } }}>
                Akash
              </Link>
            </Typography>
            <Typography variant="body2">
              Email:{' '}
              <Link href="mailto:iakshu845@gmail.com" color="inherit" sx={{ textDecoration: 'underline', '&:hover': { color: '#f57c00' } }}>
                iakshu845@gmail.com
              </Link>
            </Typography>
            <Typography variant="body2">Phone: +1 (123) 456-7890</Typography>
            <Typography variant="body2" sx={{ marginTop: '0.5rem' }}>
              Address: 123 Employee St, Suite 100, INDIA, JAMSHEDPUR 10001
            </Typography>
          </Grid>
        </Grid>
        ...
        >
          <Typography variant="body2">© {new Date().getFullYear()}(AKASH) Employee Management System. All rights reserved.</Typography>
        </Box>
      </Container>
    </Box>
  );
